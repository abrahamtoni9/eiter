<?php
    ...
    switch($_GET["op"])
    {
        case "guardaryeditar":
            ...
            $datos = $productos->get_nombre_producto($_POST["producto"]);
        ...
        case "listar":
            ...
            foreach($datos as $row)
            {
                ...
                if($row["imagen"] != '')
				{
					$sub_array[] = '<img src="upload/'.$row["imagen"].'" class="img-thumbnail" width="200" height="50" /><input type="hidden" name="hidden_producto_imagen" value="'.$row["imagen"].'" />
        ...
        case "listar_en_compras":
            ...
            foreach($datos as $row)
            {
                ...
                if($row["imagen"] != '')
                {
                    $sub_array[] = '<img src="upload/'.$row["imagen"].'" class="img-thumbnail" width="100" height="100" /><input type="hidden" name="hidden_producto_imagen" value="'.$row["imagen"].'"/>
