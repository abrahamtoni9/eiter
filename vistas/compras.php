...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>Realizar Compras de Productos a Proveedores</h1>
    ...
    <section class="content">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-6 col-lg-offset-3"> <!--offset se posiciona a 3 col dentro de la 6 col-->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      ...
                      <input type="text" class="form-control" value="<?php $codigo = $compra->numero_compra()?>" id="numero_compra" name="numero_compra" value=""  readonly>
      ...
      </section> <!--section formulario - pedido -->
  ...
  <?php
    ...
    require_once("modal/lista_proveedores_modal.php");

    // VISTA MODAL PARA AGREGAR PRODUCTO
    require_once("modal/lista_productos_modal.php");  
