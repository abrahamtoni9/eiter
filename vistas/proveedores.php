        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            ...
            <h1 class="box-title">
              ...
              <button class="btn btn-primary btn-lg" id="add_button" onclick="limpiar()" data-toggle="modal" data-target="#proveedorModal"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo proveedor</button>
